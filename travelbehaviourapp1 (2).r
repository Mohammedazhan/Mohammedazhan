...
Tb=read.csv("C:/Users/moham/Downloads/Travelbehaviour (1).csv",header=T)
  ...
  dashboardBody(tags$head( 
    ...
    tabItems(
      tabItem("home",
              ...
              img(src = "travel behaviour.png", height =570, width = 650,style="display: block; margin-left: auto; margin-right: auto;")
  ),
              tabItem("Travel",
